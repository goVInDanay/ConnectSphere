package com.connectsphere.gateway.contoller;
...
import com.connectsphere.gateway.service.FollowService;
...
public class FollowController {
	...
	public ResponseEntity<Map<String, Long>> getFollowingCount(@PathVariable int userId) {
		return ResponseEntity.ok(Map.of("followerCount", followService.getFollowingCount(userId)));
	}
