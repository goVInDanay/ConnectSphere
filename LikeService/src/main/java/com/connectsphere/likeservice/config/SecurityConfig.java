...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.csrf(csrf -> csrf.disable()).authorizeHttpRequests(auth -> auth
				.requestMatchers("/api/likes", "/api/likes/target/*/*/me", "/api/likes/target/*/*/has-liked")
				.authenticated()
				.requestMatchers("/api/likes/target/*/*", "/api/likes/target/*/*/count",
						"/api/likes/target/*/*/count-by-type", "/api/likes/target/*/*/summary", "/api/likes/user/*")
				.permitAll()
